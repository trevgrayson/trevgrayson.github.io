...
function createPropSymbols(data, map, attributes, baseMaps) {
    //create a Leafvar GeoJSON layer and add it to the map
    L.geoJson(data, {
...
function resetView(map, baseMaps) {
    ...
    L.Control.zoomHome = L.Control.extend({
        ...
        //add buttons to leafvar map
        onAdd: function (map) {
            var controlName = 'gin-control-zoom',
                container = L.DomUtil.create('div', controlName + ' leafvar-bar'),
...
// //Grab all the data and create and apply functions
